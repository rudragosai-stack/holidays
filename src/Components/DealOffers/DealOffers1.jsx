...
const DealOffers1 = () => {
  ...
  const offerContent = [
    { img: "/assets/img/offer/01.jpg", subtitle: "-50% Off", title: "Nepal City", price: "INR 160" },
    { img: "/assets/img/offer/02.jpg", subtitle: "-50% Off", title: "Mishor", price: "INR 160" },
    { img: "/assets/img/offer/03.jpg", subtitle: "-50% Off", title: "China City", price: "INR 160" },
    { img: "/assets/img/offer/04.jpg", subtitle: "-50% Off", title: "New York City", price: "INR 160" },
  ];
          ...
          <div className="col-lg-8">
            <div className="section-title-area">
              <div className="section-title">
                <span className="sub-title text-white wow fadeInUp">Deals & Offers</span>

...
export default function Header1({ variant }) {
  ...
  return (
    <div>
      <header
        className={`cs_site_header header_style_2 header_style_2_0 cs_style_1 header_sticky_style1 ${variant ? variant : ""} cs_sticky_header cs_site_header_full_width ${
            ...
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                <Link className="cs_site_branding" to="/" href="/">
                  <img src="/assets/img/logo/black-logo.svg" alt="Logo" style={{ height: "50px", width: "auto" }} />
                </Link>
              </div>

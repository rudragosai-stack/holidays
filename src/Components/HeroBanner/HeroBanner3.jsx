...
const HeroBanner3 = () => {
  const heroContent = [
    {
      img: "/mainimage/banner1.jpg",
      subtitle: "Booking Now",
      title: " Lifelong Memories Just <br>A Few Days Away",
      content:
                      ...
                      <div className="hero-content">
                        ...
                        <div className="about-button" data-animation="fadeInUp" data-delay="1.8s">
                          <Link to="/tour/tour-details" className="theme-btn">
                            Explore Flight<i className="bi bi-arrow-right"></i>
                          </Link>
                          <Link to="/tour/tour-details" className="theme-btn style-2">
                            Book A Stay<i className="bi bi-arrow-right"></i>
                          </Link>
                        </div>
                      </div>
                    </div>

  ...
  useEffect(() => {
    const loadHeroBanners = async () => {
      try {
        ...
        const response = await fetch("/api/v2024-01-01/data/query/production?query=*%5B_type+%3D%3D+%22heroBanner%22+%26%26+isActive+%3D%3D+true%5D+%7C+order%28order+asc%29");

...
function stegaEncodeSourceMap(result, resultSourceMap, config) {
  ...
  if (!enabled) {
    ...
    throw (_a = logger == null ? void 0 : logger.error) == null ? void 0 : _a.call(logger, `[@sanity/client]: ${msg}`, { result, resultSourceMap, config }), new TypeError(msg);
  }
  if (!resultSourceMap)
  ...
  if (!config.studioUrl) {
    ...
    throw (_c = logger == null ? void 0 : logger.error) == null ? void 0 : _c.call(logger, `[@sanity/client]: ${msg}`, { result, resultSourceMap, config }), new TypeError(msg);
  }
  const report = {
    encoded: [],
    skipped: []
  ...
  if (logger) {
    ...
    if ((isSkipping || isEncoding) && ((_d = (logger == null ? void 0 : logger.groupCollapsed) || logger.log) == null ? void 0 : _d("[@sanity/client]: Encoding source map into result"), (_e = logger.log) == null ? void 0 : _e.call(
      logger,
...
//# sourceMappingURL=stegaEncodeSourceMap-NM7FC3SN.js.map
